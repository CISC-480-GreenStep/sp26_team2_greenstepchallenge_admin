...
const challenges = [
  ...
  },
  {
    ...
    description:
      "Month-long April challenge with tiered difficulty levels (Good, Better, Best) across Water, Food, Consumption & Waste, and Energy categories. Participants chose their commitment level and tracked daily progress.",
    category: "General Sustainability",
    theme: "#FF9800",
  ...
  },
  {
    ...
    description:
      "Month-long April challenge with five daily yes/no sustainability actions: Water, Food, Consumption, Energy, and Transportation. Participants earned points for each completed action per day.",
    category: "General Sustainability",
    theme: "#00BCD4",
