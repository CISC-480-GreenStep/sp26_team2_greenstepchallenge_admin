        ...
        <>
          ...
          >
            <Box>
              ...
              <Typography variant="caption" color="text.secondary">
                Sustainability actions completed in challenges — this is what shows on challenge
                leaderboards
              </Typography>
            </Box>
            <CSVExport
        ...
        <>
          ...
          >
            <Box>
              ...
              <Typography variant="caption" color="text.secondary">
                System actions like created challenge, exported report — admins only; GeneralUsers
                typically have none
              </Typography>
            </Box>
