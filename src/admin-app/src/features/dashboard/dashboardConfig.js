...
export const WIDGETS = [
  // ─── Overview Stats ───────────────────────────────────
  { id: 'stat-active-challenges', title: 'Active Challenges', description: 'Count of currently active challenges', category: 'overview', defaultW: 3, defaultH: 2, minW: 1, minH: 2 },
  { id: 'stat-total-actions', title: 'Total Actions Taken', description: 'Total completed actions across all challenges', category: 'overview', defaultW: 3, defaultH: 2, minW: 1, minH: 2 },
  { id: 'stat-active-users', title: 'Active Users', description: 'Number of currently active users', category: 'overview', defaultW: 3, defaultH: 2, minW: 1, minH: 2 },
  { id: 'stat-total-points', title: 'Total Points Earned', description: 'Sum of all points earned across users', category: 'overview', defaultW: 3, defaultH: 2, minW: 1, minH: 2 },
  { id: 'stat-completion-rate', title: 'Completion Rate', description: 'Percentage of active users who completed at least one action', category: 'overview', defaultW: 3, defaultH: 2, minW: 1, minH: 2 },
  { id: 'stat-avg-points', title: 'Avg Points Per User', description: 'Average points earned per active participant', category: 'overview', defaultW: 3, defaultH: 2, minW: 1, minH: 2 },
  { id: 'stat-new-users', title: 'New Users This Month', description: 'Users registered in the current calendar month', category: 'overview', defaultW: 3, defaultH: 2, minW: 1, minH: 2 },
  { id: 'stat-top-category', title: 'Top Category', description: 'Most popular action category by completions', category: 'overview', defaultW: 3, defaultH: 2, minW: 1, minH: 2 },
  ...
  { id: 'chart-group-performance', title: 'Group Performance', description: 'Participation and points comparison across groups', category: 'charts', defaultW: 6, defaultH: 7, minW: 3, minH: 5 },
  { id: 'chart-completion-rates', title: 'Challenge Completion Rates', description: 'Horizontal bar chart of completion percentage per challenge', category: 'charts', defaultW: 6, defaultH: 7, minW: 3, minH: 5 },
  { id: 'chart-points-distribution', title: 'Points Distribution', description: 'Histogram of how points are distributed among users', category: 'charts', defaultW: 6, defaultH: 7, minW: 3, minH: 5 },

  // ─── Tables & Lists ──────────────────────────────────
  { id: 'table-challenge-summary', title: 'Challenge Summary', description: 'Table of all non-archived challenges with key metrics', category: 'tables', defaultW: 7, defaultH: 8, minW: 3, minH: 5 },
  { id: 'list-leaderboard', title: 'Global Leaderboard', description: 'Top users ranked by cumulative points', category: 'tables', defaultW: 6, defaultH: 8, minW: 3, minH: 5 },
  { id: 'table-most-active', title: 'Most Active Users', description: 'Users ranked by number of completed actions', category: 'tables', defaultW: 6, defaultH: 8, minW: 3, minH: 5 },
  { id: 'list-recent-activity', title: 'Recent Activity', description: 'Latest completed actions with user and challenge info', category: 'tables', defaultW: 6, defaultH: 8, minW: 3, minH: 5 },
  { id: 'list-upcoming', title: 'Upcoming Challenges', description: 'Challenges scheduled to start in the future', category: 'tables', defaultW: 6, defaultH: 6, minW: 2, minH: 4 },
];
...
export const LAYOUT_PRESETS = [
  ...
  },
  {
    ...
    visible: [
      'stat-active-challenges', 'stat-total-actions', 'stat-active-users', 'stat-total-points',
      'stat-completion-rate', 'stat-avg-points',
      'chart-challenge-status', 'list-leaderboard',
    ],
