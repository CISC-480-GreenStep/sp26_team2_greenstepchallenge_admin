const presets = [
  {
    ...
    actions: [
      ...
      { name: 'Fix a Leak', description: 'Check faucets, toilets, and hoses for leaks and fix or report them.', category: 'Water', points: 10 },
      { name: 'Reduce Toilet Flushes', description: 'Only flush after "number two" to reduce water use.', category: 'Water', points: 4 },
      { name: 'Full Laundry Loads Only', description: 'Only run the washing machine with full loads and use cold water.', category: 'Water', points: 6 },
    ],
  ...
  },
  {
    ...
    actions: [
      ...
      { name: 'Use Stairs Instead of Elevator', description: 'Take the stairs to reduce elevator energy and improve health.', category: 'Energy', points: 4 },
      { name: 'Switch to LED', description: 'Replace at least one incandescent or CFL bulb with LED.', category: 'Energy', points: 10 },
    ],
    createdAt: '2026-02-01',
  },
  {
    ...
    actions: [
      ...
      { name: 'Bike to Work', description: 'Commute by bicycle for the day.', category: 'Transportation', points: 10 },
      { name: 'Walk or Run', description: 'Walk or run to your destination instead of driving.', category: 'Transportation', points: 10 },
      { name: 'Combine Errands', description: 'Plan your trips to reduce total miles driven.', category: 'Transportation', points: 6 },
    ],
